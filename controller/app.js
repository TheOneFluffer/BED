...
//Endpoint 7
app.get('/game/:platformid', function (req, res) {
    //retrieve user input
...
//Endpoint 10
app.post('/users/:uid/game/:gid/review/', function (req, res) //Somewhat complete, needs some more tweaking
{
    //retrieve user input
    ...
    reviewDB.addReviews(userid, gameid, content, rating, function (err, results) {
        if (err) {
                console.log(err);
                res.status(500);
                res.type("json");
